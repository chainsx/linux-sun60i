...
override KERNELDIR := /home/chainsx/data/allwinner/a733/linux-sun60i
override KERNEL_ID := 5.15.147+
override PVRSRV_MODULE_BASEDIR := /lib/modules/5.15.147+/extra/
override KERNEL_COMPONENTS := srvkm
override KERNEL_CROSS_COMPILE := aarch64-linux-gnu-
override KERNEL_CC := aarch64-linux-gnu-gcc
override KERNEL_LD := aarch64-linux-gnu-ld
override KERNEL_NM := aarch64-linux-gnu-gcc-nm
override KERNEL_OBJCOPY := aarch64-linux-gnu-objcopy
